...
- Server-side Campus One JWT signature verification is enabled for protected route authorization through `CAMPUS_ONE_AUTH_SECRET`; spoofed or invalid bearer tokens are rejected before role checks.
